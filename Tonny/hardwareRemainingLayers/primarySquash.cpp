...
constexpr std::size_t INPUT_SIZE = wrapper_constants_v3::PRIMARY_SQUASH_INPUT_COUNT;
constexpr std::size_t OUTPUT_SIZE = wrapper_constants_v3::PRIMARY_SQUASH_OUTPUT_COUNT;
...
int main(int argc, char* argv[])
{
    ...
    const std::string input_filename = argc > 5 ? argv[5] : "primarycaps_output.txt";
    ...
    for (uint32_t i = 0; i < WARMUP_RUNS; ++i) {
        ...
        accelerator.run_primary_squash_kernel();
        accelerator.read_primary_squash_kernel(output.data());
    }
