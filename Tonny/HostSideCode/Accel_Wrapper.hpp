...
public: 
    ...
    Accel_Wrapper(const std::string& xclbin_path)
    {
        device = xrt :: device(0);
    ...
    {
        std::vector<int32_t> digitcaps_weight_fixed( wrapper_constants::DIGITCAPS_WEIGHT_COUNT);
        ...
        digitcaps_weight_bo.write(digitcaps_weight_fixed.data(),wrapper_constants::DIGITCAPS_WEIGHT_BYTES,0);
